...
const infrastructure: typeSkills[] = [
  {
  ...
  {
    srcImage: "/tech/docker.svg",
    title: "Docker",
    disc: `In use since: 2023, over ${getYearsSinceDate(
      new Date("2023"),
    )} years`,
  },
];
const ai: typeSkills[] = [
  ...
  {
    srcImage: "/tech/github-copilot.svg",
    title: "Github Copilot",
    disc: `In use since: 2025, over ${getYearsSinceDate(
      new Date("2025"),
    )} years`,
  },
  {
    srcImage: "/tech/chatgpt.svg",
    title: "chatgpt",
    disc: `In use since: 2025, over ${getYearsSinceDate(
      new Date("2025"),
    )} years`,
      ...
      <section className="mb-8 print:mb-1  max-w-2xl mx-auto px-5">
        ...
        <div className="flex flex-col mt-2 relative">
          <div className="flex flex-col sm:flex-row gap-1 items-left sm:items-center ">
            <div className="text-base text-neutral-400 sm:w-28 sm:min-w-28 sm:mr-1 flex-shrink-0">
              Codding
            </div>
            <div className="flex flex-wrap gap-3 items-center relative">
              {codding.map((value, index) => {
                return (
                  <div
                    key={index}
          ...
          <div className="flex flex-col sm:flex-row gap-1 items-left sm:items-center ">
            ...
            <div className="flex flex-wrap gap-3 items-center relative">
              {infrastructure.map((value, index) => {
                return (
                  <div
                    key={index}
                    className="w-8 h-8 mb-3 flex items-center justify-center mr-3 md:relative"
        ...
        <div className="mb-1 mt-6 text-md">
